              ...
              <div>
                ...
                <div className="mt-5 space-y-2">
                  <a
                    ...
                    className="flex items-center gap-3 rounded-lg border border-ctp-mauve/30 bg-ctp-mauve/10 p-2.5 text-xs text-ctp-mauve transition-colors hover:border-ctp-mauve/60 hover:bg-ctp-mauve/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ctp-mauve/70 focus-visible:ring-offset-2 focus-visible:ring-offset-ctp-base"
                  >
                  ...
                  <a
                    ...
                    className="flex items-center gap-3 rounded-lg border border-ctp-surface0 bg-ctp-crust/60 p-2.5 text-xs text-ctp-subtext0 transition-colors hover:border-ctp-surface1 hover:text-ctp-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ctp-lavender/70 focus-visible:ring-offset-2 focus-visible:ring-offset-ctp-base"
                  >
